        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TelegramVerified = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CuotaSocio = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CuotaFester = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Piratas Berberiscos" },
                    { 2, "Tuaregs" },
                    { 3, "Moros del Riff" },
                    { 4, "Negres" },
                    { 5, "Artillería del Islam" },
                    { 6, "Moros de Capeta" },
                    { 7, "Moros Mercaders" },
                    { 8, "Artillería Mora" },
                    { 9, "Moros Pak-kos" },
                    { 10, "Guardia Negra" },
                    { 11, "Beduins" },
                    { 12, "Artillería Cristiana" },
                    { 13, "Piratas Corsarios" },
                    { 14, "Contrabandistas" },
                    { 15, "Pescadors" },
                    { 16, "Caçadors" },
                    { 17, "Catalans" },
